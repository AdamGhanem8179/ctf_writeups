...
• First thing I did was scan all the ports between 31000 and 32000 using nmap  
• I found the port with SSL/Unknown so I  tried to connect the same way I did in level 15  
• I got an RSA key and did the same way I did before to send it and go to the next level  
...
Explanation  
Explain:  
• Sv checks what is the type of the port when nmap pings them example SSL echo TCP unkown ….  
...
How to check ports using nmap to see the best option for me  
